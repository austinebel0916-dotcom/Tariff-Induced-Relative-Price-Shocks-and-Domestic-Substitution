...
print("2SLS no-2020 sample shape:", reg.shape)
...
print("\n" + "=" * 80)
print("SECOND STAGE, NO 2020")
print("=" * 80)
print(second_stage.summary())

print("\n" + "=" * 80)
print("REDUCED FORM, NO 2020")
print("=" * 80)
...
sample_out = DATA_CLEAN / "naics4_preliminary_2sls_no2020_sample.csv"
